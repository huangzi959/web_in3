    ...
    <div class="st-sidemenu-con">
        <ul>
            <?php if(!empty($GLOBALS['cfg_weibo_url'])) { ?>
                <li class="microblog"><a href="<?php echo $GLOBALS['cfg_weibo_url'];?>" target="_blank">微博</a></li>
            <?php } ?>
            <?php if(!empty($GLOBALS['cfg_weixin_logo'])) { ?>
            <li class="wechat">微信<div class="wechat-box"><img src="<?php echo $GLOBALS['cfg_weixin_logo'];?>"></div></li>
            <?php } ?>
