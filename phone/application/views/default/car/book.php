            ...
            <div class="book_type">
                ...
                <div class="people_num">
                    <p>
                        <strong>开始日期：</strong>
                        <span>
                            <input type="text" style="  width: 200px;border: 0;text-align: left" class="startdate" name="startdate" id="startdate" value="{date('Y-m-d',strtotime('+1 day'))}"/>
                        </span>
                        <span>&gt;</span>
                    </p>
                    ...
                    <p>
                        <strong>结束日期：</strong>
                        <span>
                            <input type="text" style="  width: 200px;border: 0;text-align: left" class="leavedate" name="leavedate" id="leavedate" value="{date('Y-m-d',strtotime('+2 day'))}"/>
                        </span>
                        <span>&gt;</span>
                    </p>
