...
>
                   ...
                   <div  class="version" id="version_1" <?php if($config['cfg_mobile_version']!=1) { ?>style="display:none"<?php } ?>
>
                  <div class="nr-list">
                      <h4 class="tit"><span class="fl">手机域名：</span></h4>
                      <div class="txt">
                          <input type="text" name="cfg_m_main_url" id="cfg_m_main_url" class="set-text" value="<?php echo $config['cfg_m_main_url'];?>" /><span class="must-input hide"><i>* 必填</i></span><span class="fanlie">没有绑定独立二级域名，请填写主站域名http://www.xxx.com，如：http://www.stourweb.com；有绑定则填写参考：http://x.xxx.com，如：http://m.stourweb.com </span>
                      </div>
                  </div>
                  <div class="nr-list">
                      <h4 class="tit"><span class="fl">图片域名：</span></h4>
                      <div class="txt">
                          <input type="text" name="cfg_m_img_url" id="cfg_m_img_url" class="set-text" value="<?php echo $config['cfg_m_img_url'];?>" /><span class="must-input hide"><i>* 必填</i></span>
                  ...
                  <div class="nr-list">
                      ...
                      <div class="txt">
                          <input type="text" name="cfg_m_phone" id="cfg_m_phone" class="set-text" value="<?php echo $config['cfg_m_phone'];?>" />
                      </div>
                  </div>
                  <div class="nr-list">
                      <h4 class="tit"><span class="fl">版权信息：</span></h4>
                      <div class="txt">
                          <input type="text" name="cfg_m_icp" id="cfg_m_icp" class="set-text" value="<?php echo $config['cfg_m_icp'];?>" />
                      </div>
                  </div>
                  </div>
              </div>
               ...
               <div id="m_tj_div" class="mitem nr-list" style="display:none">
                   <div class="nr-list">
                       ...
                       <div class="txt">
                           <textarea id="cfg_m_tongjicode" name="cfg_m_tongjicode"  cols="" rows="8" class="set-area" style="height: 300px;"><?php echo $config['cfg_m_tongjicode'];?></textarea>
                       </div>
                   </div>
               </div>
                <div class="opn-btn">
