                          ...
                          <div class="pay-one" id="pay_weixinpay" style="display: none">
                              <div class="pay-sg">
                                  <table>
                                      ...
                                      <tr>
                                          <td class="tit"  style="width:100%" colspan="2"><span class="tit-sp">证书上传路径:</span><br/>
                                              <span class="tit-sp" style="padding-left:30px">4.0版本及以前的证书目录：\shouji\public\thirdpay\weixinpay\WxPayPubHelper\cacert 和 \thirdpay\weixinpay\cert目录下</span><br/>
                                              <span class="tit-sp" style="padding-left:30px">5.0版本及以上的证书目录：\payment\application\vendor\mobile\wxpay\cert目录下</span></td>
                                      </tr>
                                  </table>
                              </div>
                          </div>
