...
<head>
    <meta charset="utf-8">
    <title>模块页面配置-思途CMS<?php echo $coreVersion;?></title>
...
<script>
var ismobile = "<?php echo $ismobile;?>";//是否手机版
Ext.onReady(
    function () {
        //store
        $(".isattr").addClass('on');
        ...
        window.attr_store = Ext.create('Ext.data.TreeStore', {
            ...
            proxy: {
                ...
                api: {
                    read: SITEURL+'templet/index/action/read/ismobile/<?php echo $ismobile;?>',  //读取数据的URL
                    update:  SITEURL+'templet/index/action/save/ismobile/<?php echo $ismobile;?>',
                    destroy:  SITEURL+'templet/index/action/delete/ismobile/<?php echo $ismobile;?>'
                },
                reader: 'json'
            },
            autoLoad: true,
