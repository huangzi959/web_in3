    ...
    <div class="top-page">
        ...
        <div class="top-operate">
            <ul class="fl">
                ...
                <li class="manager">
                    <a href="http://bbs.sasadown.cn" target="_blank">帮助中心</a>

                    <div class="top-help-list">
                        <a class="ico_1" target="_blank" href="http://bbs.sasadown.cn">使用帮助</a>
                        <a class="ico_2" target="_blank" href="javascript:;">视频教程</a>
                        <a class="ico_3" target="_blank" href="http://bbs.sasadown.cn">意见反馈</a>
                        <a class="ico_4" target="_blank" href="http://bbs.sasadown.cn">思途官网</a>
                        <a class="ico_5" target="_blank" href="http://bbs.sasadown.cn">关于系统</a>
                    </div>
                </li>
