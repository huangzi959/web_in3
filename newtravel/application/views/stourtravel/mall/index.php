...
<scirpt id="apps" type="text/html">
    ...
    <li>
        <div class="listCon">
            ...
            <div class="listTxt cursor app_info" data="mall/info/parentkey/mall/itemid/5/number/{{v.number}}">
                <h3>{{v.name}}</h3>

                <p>{{v.summary}}</p>
                <a class="app_info cursor">更多详情 &gt;</a>
            </div>
        </div>
        <div class="list-data">
            ...
            {{else}}
            <a class="now-gm-btn install-btn cursor" onclick="ST.Util.addTab('我的应用','mall/app/parentkey/mall/itemid/1')">安装</a>
            {{/if}}
            {{else}}
