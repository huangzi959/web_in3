            ...
            columns: [
                ...
                },
                {
                    ...
                    renderer: function (value, metadata, record) {
                        ...
                        var html='<span class="cursor app-update hide" onclick="ST.Util.addTab(\'应用更新\',\'upgrade/index/parentkey/mall/itemid/1/apppart/'+id+'?appname='+name+'\')">更新</span>';
   ...
   function updateCheck(){
       ...
       $.ajax({
           ...
           success: function (data) {
               for (var i in data){
                   var obj=data[i].versioninfo;
                   if (obj.newestVersioninfo != undefined && obj.cVersion != obj.newestVersioninfo.version){
                       $('#installed'+obj[val].id).parent().find('.app-update').removeClass('hide');
                   }
               }
           }
       });
