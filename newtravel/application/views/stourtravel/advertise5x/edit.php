                        ...
                        <div class="add-class">
                            ...
                            <dl>
                                ...
                                <dd id="prefix-num">
                                    ...
                                    <input type="input" id="custom_label"  name="custom_label" {if $info['is_system']=='s_'}disabled{/if} value="{$info['custom_label']}"/> <span class="red" id="custom_label_err"></span>
                                </dd>
                            </dl>
                            <dl>
                                <dt>目的地选择：</dt>
                                    ...
                                    <div class="up-list-div">
                                        ...
                                        <ul class="pic-sel" id="img-list">
                                            ...
                                            <li>
                                                ...
                                                <span class="fl">排序：<input type="text" name="adorder[]" id="order" class="set-text-xh img_text w100" value="{$v[3]}"/></span>
                                        ...
                                        <script type="text/html" id="img-temp">
                                            ...
                                            <li>
                                                ...
                                                <span class="fl">排序：<input type="text" name="adorder[]" id="order" class="set-text-xh img_text w100" value=""/></span>
