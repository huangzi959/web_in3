          ...
          <div class="manage-nr">
              ...
              <!--/基础信息结束-->
                  ...
                  <div class="product-add-div" data-id="traffic">
                      {php Common::getEditor('traffic',$info['traffic'],700,400);}
                  </div>
                  <div class="product-add-div" data-id="aroundspots">
                      {php Common::getEditor('aroundspots',$info['aroundspots'],700,400);}
                  </div>
                  <div class="product-add-div" data-id="notice">
                      {php Common::getEditor('notice',$info['notice'],700,400);}
                  </div>
                  <div class="product-add-div" data-id="equipment">
                      {php Common::getEditor('equipment',$info['equipment'],700,400);}
                  </div>
